...
public class ReactorCrawler
    ...
    protected Flux<Image> transformImageRemotely(Image image) {
       ...
       // Flux.
        ...
        MultipartBody.Part part = remoteDataSource.buildMultipartBodyPart(this, image);
        RemoteDataSource.TransformApi api = remoteDataSource.getApi();
        return  Flux.fromIterable(api.applyTransforms(getTransformNames(), part))
